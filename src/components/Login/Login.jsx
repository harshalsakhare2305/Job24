        ...
        Your Email
                    ...
                    <button type="submit"  onClick={signIn} className='w-96 mb-4 text-[18px] mt-6 rounded-full bg-blue-500 text-white-600 hover:text-green-500 py-2 transition-colors duration-300'>Login</button>
                       ...
                       <div className='flex flex-col '>
                            <button onClick={googlesignIn} type="submit" className='w-72 mb-4 text-[18px] mt-6 rounded-full bg-white text-black-600 hover:text-blue-500 py-2 transition-colors duration-300'>
                              <span><img src="../../google.png" alt="googlepng" className='h-6 w-6 inline ' /></span>  Signin with Google </button>
