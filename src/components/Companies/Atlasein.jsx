...
import GSlogo from '../Assets/Atlassian-Logo.png'
const data = [
    {
        ...
        <div className="p-4">
            <div className="bg-yellow-300 rounded-md shadow-md">
                <div className="flex justify-between p-4 border-b">
                    <h2 className="text-lg font-bold hover:text-blue-400"><a href="https://www.atlassian.com/company/careers" target='blank'>Atlassian</a></h2>
